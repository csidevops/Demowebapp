pipeline {
    ...
    stages {
        ...
        stage('Performance Testing') {
            steps {
                bat 'jmeter -n -t ${WORKSPACE}\\project_name\\src\\test\\java\\com\\example\\jmeter\\*.jmx -l ${WORKSPACE}\\project_name\\JmeterResult.jtl'
                perfReport '${WORKSPACE}\\project_name\\JmeterResult.jtl'
            }
        }
    }
